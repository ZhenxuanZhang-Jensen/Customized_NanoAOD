...
export SCRAM_ARCH=slc7_amd64_gcc700
cp /eos/cms/store/group/phys_higgs/cmshgg/zhenxuan/custom_nanoAOD/CMSSW_10_6_25_sig_17_SL_submit.tgz .
tar -xf CMSSW_10_6_25_sig_17_SL_submit.tgz
...
echo "+=============================="
mkdir /eos/user/z/zhenxuan/customized_NanoAOD/UL17/${5}
mkdir /eos/user/z/zhenxuan/customized_NanoAOD/UL17/${5}/${6}
cp nano.root /eos/user/z/zhenxuan/customized_NanoAOD/UL17/$5/$6/out_${4}_${1}_${2}.root
date
