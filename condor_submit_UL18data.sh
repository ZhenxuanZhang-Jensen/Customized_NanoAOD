...
export SCRAM_ARCH=slc7_amd64_gcc700
cp /eos/cms/store/group/phys_higgs/cmshgg/zhenxuan/custom_nanoAOD/CMSSW_10_6_2518data.tgz .
tar -xf CMSSW_10_6_2518data.tgz
rm CMSSW_10_6_2518data.tgz
...
sed -i "s#MiniAODFileWithPath#${3}#g"  data2018_NANO.py
# cat for debug, as this will be printed out in stdout of condor log
cat data2018_NANO.py
#cat ${3}
echo "========================="
echo "==> cmsRun   data2018_NANO.py"
