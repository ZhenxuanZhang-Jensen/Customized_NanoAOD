...
export SCRAM_ARCH=slc7_amd64_gcc700
cp /eos/cms/store/group/phys_higgs/cmshgg/zhenxuan/custom_nanoAOD/CMSSW_10_6_25_das_samples_W_jets_calibration_submit.tgz .
tar -xf CMSSW_10_6_25_das_samples_W_jets_calibration_submit.tgz
